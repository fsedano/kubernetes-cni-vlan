...
def common_setup(vlan_id, the_file):
    ...
    try_cmd("ip link set ens192 promisc on", the_file)
    ...
    try_cmd("ip link set ens192.{} promisc on".format(vlan_id), the_file)
    ...
    try_cmd("ip link set {} promisc on".format(br_name), the_file)
